...
public struct ThemeTypography {
    ...
    public static let defaultLight = ThemeTypography(
        displayLarge: .jakarta(44, weight: .bold),
        displayMedium: .jakarta(40, weight: .bold),
        displaySmall: .jakarta(32, weight: .bold),

        headlineLarge: .jakarta(24, weight: .semibold),
        headlineMedium: .jakarta(20, weight: .semibold),
        headlineSmall: .jakarta(18, weight: .medium),

        titleLarge: .jakarta(18, weight: .semibold),
        titleMedium: .jakarta(16, weight: .medium),
        titleSmall: .jakarta(14, weight: .medium),

        labelLarge: .jakarta(14, weight: .semibold),
        labelMedium: .jakarta(12, weight: .medium),
        labelSmall: .jakarta(11, weight: .medium),

        bodyLarge: .jakarta(18, weight: .regular),
        bodyMedium: .jakarta(16, weight: .regular),
        bodySmall: .jakarta(14, weight: .regular),

        buttonText: .jakarta(16, weight: .semibold)
    )
