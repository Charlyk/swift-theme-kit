...
extension ThemePlatform {
  ...
  func checkboxSize(for sizeCategory: CheckboxSizeToken) -> CGFloat {
    let base = baseCheckboxSize()
    switch sizeCategory {
    case .small:
      return base
    case .medium:
  ...
  func checkboxFontStyle(for sizeCategory: CheckboxSizeToken) -> TextStyleToken {
    switch self {
    case .macOS:
      switch sizeCategory {
      case .small:
  ...
  func checkboxLabelSpacing(for sizeCategory: CheckboxSizeToken) -> SpacingToken {
    switch self {
    case .macOS:
      switch sizeCategory {
  ...
  /// Returns the stroke width to use for the checkbox border depending on size and platform.
  ///
  ...
  func checkboxStrokeWidth(for sizeCategory: CheckboxSizeToken) -> StrokeToken {
    switch self {
    case .macOS:
      switch sizeCategory {
      case .small:
